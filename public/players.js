...
function findWasmBinary() {
	return locateFile("players.wasm");
}
...
var _wasm_ring_init = (Module["_wasm_ring_init"] = makeInvalidEarlyAccess("_wasm_ring_init"));
var _wasm_ring_set_center = (Module["_wasm_ring_set_center"] =
	makeInvalidEarlyAccess("_wasm_ring_set_center"));
var _wasm_ring_set_props = (Module["_wasm_ring_set_props"] =
...
var _wasm_pulse_set_color = (Module["_wasm_pulse_set_color"] =
	makeInvalidEarlyAccess("_wasm_pulse_set_color"));
var _wasm_pulse_start = (Module["_wasm_pulse_start"] = makeInvalidEarlyAccess("_wasm_pulse_start"));
var _wasm_pulse_update = (Module["_wasm_pulse_update"] =
	makeInvalidEarlyAccess("_wasm_pulse_update"));
var _wasm_pulse_dispose = (Module["_wasm_pulse_dispose"] =
	makeInvalidEarlyAccess("_wasm_pulse_dispose"));
...
function assignWasmExports(wasmExports) {
	assert(
		typeof wasmExports["wasm_ring_init"] != "undefined",
		"missing Wasm export: wasm_ring_init"
	);
	assert(
		typeof wasmExports["wasm_ring_set_center"] != "undefined",
		"missing Wasm export: wasm_ring_set_center"
	);
	assert(
		typeof wasmExports["wasm_ring_set_props"] != "undefined",
		"missing Wasm export: wasm_ring_set_props"
	);
	assert(
	...
	assert(
		...
		"missing Wasm export: wasm_ring_start"
	);
	assert(
		typeof wasmExports["wasm_ring_update"] != "undefined",
		"missing Wasm export: wasm_ring_update"
	);
	assert(
		typeof wasmExports["wasm_pulse_init"] != "undefined",
		"missing Wasm export: wasm_pulse_init"
	);
	assert(
		typeof wasmExports["wasm_pulse_set_color"] != "undefined",
		"missing Wasm export: wasm_pulse_set_color"
	);
	assert(
		typeof wasmExports["wasm_pulse_start"] != "undefined",
		"missing Wasm export: wasm_pulse_start"
	);
	assert(
		typeof wasmExports["wasm_pulse_update"] != "undefined",
		"missing Wasm export: wasm_pulse_update"
	);
	assert(
		typeof wasmExports["wasm_pulse_dispose"] != "undefined",
		"missing Wasm export: wasm_pulse_dispose"
	);
	...
	_wasm_ring_init = Module["_wasm_ring_init"] = createExportWrapper("wasm_ring_init", 3);
	_wasm_ring_set_center = Module["_wasm_ring_set_center"] = createExportWrapper(
		"wasm_ring_set_center",
		2
	);
	_wasm_ring_set_props = Module["_wasm_ring_set_props"] = createExportWrapper(
		"wasm_ring_set_props",
		4
	);
	_wasm_ring_set_colors = Module["_wasm_ring_set_colors"] = createExportWrapper(
	...
	_wasm_pulse_set_color = Module["_wasm_pulse_set_color"] = createExportWrapper(
	...
	_wasm_pulse_dispose = Module["_wasm_pulse_dispose"] = createExportWrapper(
		"wasm_pulse_dispose",
		1
	);
